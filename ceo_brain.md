...
| 6 | At least one strategy cleared gate per market | ⏳ **IN PROGRESS** | US ✅ (Divergence dSharpe 2.61 + MBV dSharpe 4.37 + PMR dSharpe 2.26 + **STR dSharpe 0.90**) · UAE ❌ · Crypto ❌. Pursued via GENUINE new prospective strategies (Path A). Stop: 60% per-market coverage OR 50+ attempts. | **11 strategies registered (33 trials)** as of 2026-05-22 Sprint 11:18 UTC — CMF (Chaikin Money Flow mean-rev in bullish regime) **ALL 3 MARKETS FAIL**: US PORTFOLIO_FAIL on WR-floor only (WR 33.96%, **dSharpe 5.872** — STRONGEST near-miss dSharpe to date at 11.7× floor, exp 1.396, 17,646 trades, 1,108/1,123 contributors at 98.7% coverage — 5th near-miss in WR-floor pattern); UAE PORTFOLIO_FAIL (93 trades, exp 0.764, dSh -1.54); Crypto PORTFOLIO_FAIL (566 trades, exp 0.482, dSh -3.62 brutal). Volume-flow domain (1st of its kind in the pipeline) didn't break the WR-floor pattern. Union US contributors unchanged at 1,107. Each new genuine strategy adds 3 trials to haircut. |
