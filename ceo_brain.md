...
| 6 | At least one strategy cleared gate per market | ⏳ **IN PROGRESS** | US ✅ (Divergence dSharpe 2.61 + MBV dSharpe 4.37 + PMR dSharpe 2.26 + **STR dSharpe 0.90** — STR finalized 2026-05-22 Sprint Catch-up) · UAE ❌ · Crypto ❌. Pursued via GENUINE new prospective strategies (Path A). Stop: 60% per-market coverage OR 50+ attempts. | **9 strategies registered (27 trials)** as of 2026-05-22 — STR (Stochastic %K cross-up mean-rev) **CLEARED US** with WR 55.55% (highest of all 4 cleared — hypothesis CONFIRMED that quick midpoint exit yields higher WR than full-mean-rev exits); STR UAE FAIL (13 trades, dSh -3.19); STR Crypto FAIL (268 trades, dSh -2.70). Each new genuine strategy adds 3 trials to haircut. |
